...
<template>
  <article class="lifted overflow-hidden">
    ...
    <div v-if="!revealed" class="px-6 pt-[30px] pb-7 md:px-[30px]">
      ...
      <div v-if="face.card_type === 'cloze'" class="jp my-5 text-[26px] leading-[2] md:text-[29px]">
      ...
      <p
        class="mt-3.5 mb-0 text-[14px] leading-[1.7] text-ink-70"
    ...
    <div v-else class="md:grid md:grid-cols-[1fr_1px_1fr]">
      <div class="min-w-0">
        <div class="px-6 pt-[22px] pb-5 md:px-[30px] md:pt-7">
          <header class="flex items-baseline justify-between">
          ...
          <p class="mt-2.5 mb-0 text-[46px] leading-[1.7] tracking-[0.02em] md:text-[58px]">
            <Furigana :word="face.term.headword" :reading="face.term.reading" class="reveal-ruby" />
          </p>
      ...
      <div class="min-w-0">
        <div class="px-6 pt-5 pb-[18px] md:px-[30px] md:pt-7">
