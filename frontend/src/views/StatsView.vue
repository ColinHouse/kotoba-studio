    ...
    <div v-else class="space-y-6">
      ...
      <section class="rounded-chip border border-divider bg-paper p-4 md:p-5 shadow-sm">
        ...
        >
          <div>
            ...
            <p class="type-micro text-ink-35">柱状表示当日复习次数，曲线表示 7 日滚动正确率</p>
          </div>
          <!-- Legend -->
          <div class="flex items-center gap-3 type-micro text-ink-50">
        ...
        <div class="mt-2 flex h-5 items-center justify-between type-micro text-ink-50">
          <div>
      ...
      <section class="rounded-chip border border-divider bg-paper p-4 md:p-5 shadow-sm">
        <div class="border-b border-divider pb-3">
          ...
          <p class="type-micro text-ink-35">
        ...
        <div class="mt-2 flex justify-between type-micro text-ink-35">
      ...
      <section class="rounded-chip border border-divider bg-paper p-4 md:p-5 shadow-sm">
        <div class="border-b border-divider pb-3">
          ...
          <p class="type-micro text-ink-35">各作品的生词沉淀与掌握程度</p>
        </div>
        ...
        <div v-else class="mt-3 hidden md:block overflow-x-auto">
          <table class="w-full text-left text-xs">
            <thead>
              <tr class="border-b border-divider type-micro text-ink-50">
